...
Source0  : https://github.com/draios/sysdig/archive/0.23.0.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0
Requires: sysdig-bin
Requires: sysdig-data
Requires: sysdig-license
Requires: sysdig-man
...
export LANG=C
export SOURCE_DATE_EPOCH=1533867777
mkdir clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1533867777
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/sysdig
cp COPYING %{buildroot}/usr/share/doc/sysdig/COPYING
cp userspace/sysdig/chisels/COPYING %{buildroot}/usr/share/doc/sysdig/userspace_sysdig_chisels_COPYING
pushd clr-build
%make_install
popd
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/sysdig/COPYING
/usr/share/doc/sysdig/userspace_sysdig_chisels_COPYING
