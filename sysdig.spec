...
Version  : 0.27.1
Release  : 28
URL      : https://github.com/draios/sysdig/archive/0.27.1/sysdig-0.27.1.tar.gz
Source0  : https://github.com/draios/sysdig/archive/0.27.1/sysdig-0.27.1.tar.gz
...
%prep
%setup -q -n sysdig-0.27.1
cd %{_builddir}/sysdig-0.27.1
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640290913
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/sysdig-0.27.1/COPYING %{buildroot}/usr/share/package-licenses/sysdig/783f98f43ccc3ce8a369b86bcf5f769c9c83d678
cp %{_builddir}/sysdig-0.27.1/driver/GPL2.txt %{buildroot}/usr/share/package-licenses/sysdig/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/sysdig-0.27.1/userspace/sysdig/chisels/COPYING %{buildroot}/usr/share/package-licenses/sysdig/783f98f43ccc3ce8a369b86bcf5f769c9c83d678
pushd clr-build
%make_install
popd
