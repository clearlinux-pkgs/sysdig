...
Version  : 0.19.0
Release  : 4
URL      : https://github.com/draios/sysdig/archive/0.19.0.tar.gz
Source0  : https://github.com/draios/sysdig/archive/0.19.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1507156557
mkdir clr-build
pushd clr-build
