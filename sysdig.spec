...
Version  : 0.73.1
Release  : 7
URL      : https://github.com/draios/sysdig/archive/agent/0.73.1.tar.gz
Source0  : https://github.com/draios/sysdig/archive/agent/0.73.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1511968211
mkdir clr-build
pushd clr-build
